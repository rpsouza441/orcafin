...
import br.com.rodrigo.OrcamentoPessoal.services.DespesaService;
...
public class DespesaResource {
	...
	@PutMapping(value = "/{id}")
	@PreAuthorize("hasAnyRole('ADMIN')")
	public ResponseEntity<Void> put(@Valid @RequestBody DespesaDTO dto, @PathVariable Integer id) {
	...
	public ResponseEntity<Page<DespesaDTO>> findPage(@RequestParam(value = "page", defaultValue = "0") Integer page,
	...
	private URI gerarURI(Despesa obj) {
